...
import {
    ...
    MDBRadio,
    MDBRow, MDBTabs,
    MDBTabsContent, MDBTabsItem, MDBTabsLink, MDBTabsPane,
...
function FormSupplier() {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => (
                <strong>
                    <Link to={`/supplier/edit/${params.id}`} className='btn btn-success mb-2'>Edit</Link>
...
//  Delete supplier -----------------------------------------------------------------------------------------------------
    ...
    const del = (e) => {
        ...
        axios.delete('/supplier/' + e.target.value, {headers: headers})
            .then(() => {
...
//  List group supplier ------------------------------------------------------------------------------------------------
    ...
    const getListGroupSupplier = () => {
        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.get('/group-supplier', {headers: headers})
            .then(resp => {
                setListGroupSupplier(resp.data.data)
            })
            .catch(error => {
                console.log(error)
                navigate("/")
...
//  Save supplier -------------------------------------------------------------------------------------------------------
    const [groupSupplierInitial, setGroupSupplierInitial] = useState({
        groupSupplierInitialId: ""
    })
    ...
    const [supplierSave, setSupplierSave] = useState({
        ...
        company: '',
        taxCode: '',
        groupSupplierId: groupSupplierInitial.groupSupplierInitialId,
        productId: productInitial.productInitial
    })
    ...
    const onSave = () => {
        ...
        axios.post('/supplier', data, {headers: headers})
            .then(() => {
                getList()
                toggleOpen()
            })
    ...
    const onGroupSupplierSave = () => {
        ...
        axios.post('/group-supplier', data, {headers: headers})
            .then(() => {
                getList()
                toggleOpenGroupSupplier()
            })
            .catch((error) => {
                navigate('/')
                console.log(error)
    ...
    const [groupSupplier, setGroupSupplier] = useState(false)
    ...
    const toggleOpenGroupSupplier = () => setGroupSupplier(!groupSupplier)
    const toggleOpenProduct = () => setProduct(!product)
    ...
    const inputData = (e) => {
        ...
        setGroupSupplierInitial({...groupSupplierInitial, [e.target.name]: e.target.value})
        ...
        setProductInitial({...productInitial, [e.target.name]: e.target.value})
        ...
        setSearchGroupSupplierInitial({...searchGroupSupplierInitial, [e.target.name]: e.target.value})
    ...
    const onSearchSupplierPhoneNumber = () => {
        let data = {
            phoneNumber: searchSupplierPhoneNumber.phoneNumber,
        }
        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.get('/suppliers/search-phone/' + data.phoneNumber, {headers: headers})
            .then(resp => {
                setListSupplier(resp.data.data)
            })
            .catch((error) => {
    ...
    const onSearchActive = () => {
        ...
        axios.get('/suppliers/search-supplier-active/' + data.activeId, {headers: headers})
            .then(resp => {
                setListSupplier(resp.data.data)
            })
            .catch(error => {
    ...
    const onSearchSupplierTaxCode = () => {
        let data = {
            taxCode: searchSupplierTaxCode.taxCode,
        }
        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.get('/suppliers/search-tax-code/' + data.taxCode, {headers: headers})
            .then(resp => {
                setListSupplier(resp.data.data)
            })
            .catch(error => {
    ...
    const onSearchSupplierName = () => {
        let data = {
            supplierName: searchSupplierName.supplierName,
        }
        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.get('/suppliers/search-name/' + data.supplierName, {headers: headers})
            .then(resp => {
                setListSupplier(resp.data.data)
            })
            .catch(error => {
    ...
    //  Search group supplier ------------------------------------------------------------------------------------------------
    const [searchGroupSupplierInitial, setSearchGroupSupplierInitial] = useState({
        groupSupplierInitial: ''
    })
    const [searchGroupSupplier, setSearchGroupSupplier] = useState({
        groupSupplierId: searchGroupSupplierInitial.groupSupplierInitial
    })
    const onSearchGroupSupplier = () => {
        let data = {
            groupSupplierId: searchGroupSupplier.groupSupplierId,
        }

        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.get('/suppliers/search-group-supplier/' + data.groupSupplierId, {headers: headers})
            .then(resp => {
                setListSupplier(resp.data.data)
            })
            .catch(error => {
            ...
            <MDBContainer>
                <MDBRow>
                    <MDBCol size='md-2 mt-3'>
                        <MDBRow>
                            <MDBCol>
                                <h5 style={{color: "black"}}><b>Nhà cung cấp</b></h5>
                            </MDBCol>
                        </MDBRow>
                    </MDBCol>
                    <MDBCol size='md-10 mt-3'>
                        <MDBRow>
                                                ...
                                                <MDBRow>
                                                    <MDBCol md='8'>
                                                        <MDBInput className={"bg-white"}
                                                                  ...
                                                                  label='Theo tên nhà cung cấp' size='lg'
                                                                  type='text'/>
                                                    </MDBCol>
                                                    <MDBCol>
                                                        <MDBBtn className='btn btn-success mb-5 text-end'
                                                                onClick={onSearchSupplierName}>Tìm kiếm</MDBBtn>
                                                    </MDBCol>
                                                </MDBRow>
                                                <MDBRow>
                                                    <MDBCol md='8'>
                                                        <MDBInput className={"bg-white"}
                                                                  ...
                                                                  onChange={inputData} wrapperClass='mb-4'
                                                                  label='Theo số điện thoại' size='lg'
                                                                  type='text'/>
                                                    </MDBCol>
                                                    <MDBCol>
                                                        <MDBBtn className='btn btn-success mb-5 text-end'
                                                                onClick={onSearchSupplierPhoneNumber}>Tìm kiếm</MDBBtn>
                                                    </MDBCol>
                                                </MDBRow>
                                                <MDBRow>
                                                    <MDBCol md='8'>
                                                        <MDBInput className={"bg-white"}
                                                                  ...
                                                                  onChange={inputData} wrapperClass='mb-4'
                                                                  label='Theo mã số thuế' size='lg'
                                                                  type='text'/>
                                                    </MDBCol>
                                                    <MDBCol>
                                                        <MDBBtn className='btn btn-success mb-5 text-end'
                                                                onClick={onSearchSupplierTaxCode}>Tìm kiếm</MDBBtn>
                                                    </MDBCol>
                                                </MDBRow>
                            ...
                            <MDBCol size='md-5'>
                                <MDBRow>
                                    <MDBCol>
                                        <MDBBtn onClick={toggleOpen} className='btn btn-success form-control'
                                                style={{textTransform: 'none'}}><b>Thêm mới</b></MDBBtn>
                                        <MDBModal tabIndex='-1' open={centredModal}
                                                  onClose={() => setCentredModal(false)}>
                                            <MDBModalDialog size='xl'>
                                                <MDBModalContent>
                                                    <MDBModalHeader>
                                                        <MDBModalTitle><b>Thêm nhà cung cấp</b></MDBModalTitle>
                                                        ...
                                                        <MDBTabsContent className="mt-3">
                                                                ...
                                                                <MDBCol md="6">
                                                                    <MDBRow>
                                                                        <MDBCol md="5" className="ps-5 mt-2">
                                                                            <h6><b>Tên nhà cung cấp</b></h6>
                                                                        </MDBCol>
                                                                        <MDBCol md="7">
                                                                            <MDBInput name={'supplierName'}
                                                                                      value={supplierSave.supplierName}
                                                                                      onChange={inputData}
                                                                    ...
                                                                    <MDBRow>
                                                                        ...
                                                                        <MDBCol md="7" className="mt-3">
                                                                            <MDBInput name={'phoneNumber'}
                                                                                      value={supplierSave.phoneNumber}
                                                                                      onChange={inputData}
                                                                                      className="form-control"
                                                                                      type='text'/>
                                                                        </MDBCol>
                                                                ...
                                                                <MDBCol md="6">
                                                                    <MDBRow>
                                                                        ...
                                                                        <MDBCol md="8" className="mt-3">
                                                                            <MDBInput name={'company'}
                                                                                      value={supplierSave.company}
                                                                                      onChange={inputData}
                                                                                      className="form-control"
                                                                                      type='text'/>
                                                                        </MDBCol>
                                                            ...
                                                            <MDBRow>
                                                                ...
                                                                <MDBCol md="6">
                                                                    <MDBRow>
                                                                        <MDBCol md="3" className="ps-5 mt-2">
                                                                            <h6><b>Mã số thuế</b></h6>
                                                                        </MDBCol>
                                                                        <MDBCol md="8" className="mt-3">
                                                                            <MDBInput name={'taxCode'}
                                                                                      value={supplierSave.taxCode}
                                                                                      onChange={inputData}
                                                                                      className="form-control"
                                                                                      type='text'/>
                                                                        </MDBCol>
                                                                        ...
                                                                        <MDBCol md="7">
                                                                            <MDBInputGroup>
                                                                                <select
                                                                                    ...
                                                                                    value={supplierSave.groupSupplierId}
                                                                                    className={'form-control mt-3'}
                                                                                    required
                                                                                >
                                                                                    {listGroupSupplier.map((groupSupplier) => (
                                                                                        <option
                                                                                            key={groupSupplier.groupSupplierId}
                                                                                            value={groupSupplier.groupSupplierId}>
                                                                                            {groupSupplier.groupSupplierName}
                                                                                        </option>
                                                                                    ))}
                                                                                </select>
                                                                                <MDBBtn color='success'
                                                                                        onClick={toggleOpenGroupSupplier}
                                                                                        outline className="mt-3">Thêm
                                                                                </MDBBtn>
                                                                                <MDBModal open={groupSupplier}
                                                                                          onClose={() => setGroupSupplier(false)}
                                                                                          tabIndex='-1'>
                                                                                    <MDBModalDialog>
                                                                                        <MDBModalContent>
                                                                                            <MDBModalHeader>
                                                                                                ...
                                                                                                <MDBBtn
                                                                                                    className='btn-close'
                                                                                                    color='none'
                                                                                                    onClick={toggleOpenGroupSupplier}></MDBBtn>
                                                                                            </MDBModalHeader>
                                                                                            <MDBModalBody>
                                                                                                <MDBRow>
                                                                                                    <MDBCol md="4"
                                                                                                    ...
                                                                                                    <MDBCol md="7">
                                                                                                        <MDBInput
                                                                                                            ...
                                                                                                            value={groupSupplierSave.groupSupplierName}
                                                                                                            onChange={inputData}
                                                                                                            className="form-control"
                                                                                                            type='text'/>
                                                                                                    </MDBCol>
                                                                                        ...
                                                                                        <MDBModalContent>
                                                                                            <MDBModalHeader>
                                                                                                ...
                                                                                                <MDBBtn
                                                                                                    className='btn-close'
                                                                                                    color='none'
                                                                                                    onClick={toggleOpenProduct}></MDBBtn>
                                                                                            </MDBModalHeader>
                                                                                            <MDBModalBody>
                                                                                                <MDBTabs
                                                                                                    className='mb-3'>
                                                                                                                    ...
                                                                                                                    <MDBCol
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <label
                                                                                                                                ...
                                                                                                                                htmlFor="flexSwitchCheckChecked">Bán
                                                                                                                                trực
                                                                                                                                tiếp</label>
                                                                                                                        </div>
                                                                                                                    </MDBCol>
                                                                                            ...
                                                                                            <MDBModalFooter>
                                                                                                <MDBBtn color='success'
                                                                                                        onClick={onProductSave}><b>Lưu</b></MDBBtn>
                                                                                                <MDBBtn color='success'
                                                                                                        onClick={onProductSave}><b>Lưu
                                                                                                    & Thêm
                                                                                                    mới</b></MDBBtn>
                                                                                                <MDBBtn color='success'
                                                                                                        onClick={onProductSave}><b>Lưu
                                    ...
                                    <MDBCol className='text-end'>
                                        <MDBBtn className='btn btn-success form-control'
                                                style={{textTransform: 'none'}}><b>Import</b></MDBBtn>
                                    </MDBCol>
                                    <MDBCol className='text-end'>
                                        <MDBBtn className='btn btn-success form-control' onClick={exportToExcel}
                                                style={{textTransform: 'none'}}><b>Export</b></MDBBtn>
                                    </MDBCol>
                                </MDBRow>
                            </MDBCol>
                        </MDBRow>
                    ...
                    <MDBCol size="md-2">
                            ...
                            <MDBCol>
                                <div className="w-100 p-3 shadow mb-3 bg-white rounded-4">
                                    ...
                                    <select
                                        ...
                                        required
                                    >
                                        {listGroupSupplier.map((groupProduct) => (
                                            <option
                                                key={groupProduct.groupProductId}
                                                value={groupProduct.groupSupplierId}>
                                                {groupProduct.groupSupplierName}
                                            </option>))}
                                    </select>
                                </div>
                            </MDBCol>
                        ...
                        <MDBRow>
                            <MDBCol>
                                <div className="w-100 p-3 shadow mb-3 bg-white rounded-4">
                                    <p><b>Tổng mua</b></p>
                                    <MDBRadio name='number' onClick={getList} label='Tất cả'/><br/>
                                    <MDBRadio name='number' label='Trên 10tr'/><br/>
                                    <MDBRadio name='number' label='5tr đến 10tr'/><br/>
                                    <MDBRadio name='number' label='dưới 5tr'/><br/>
                                </div>
                            </MDBCol>
                        </MDBRow>
                        <MDBRow>
                            <MDBCol>
                                <div className="w-100 p-3 shadow mb-3 bg-white rounded-4">
                                    ...
                                    <MDBRadio name='activeId'
                                              ...
                                              onClick={onSearchActive}
                                              defaultChecked
                                              label='Đang hoạt động'/><br/>
                                    <MDBRadio name='activeId'
                                              id='activeId'
                                              value={3}
                                              onChange={inputData}
                                              onClick={onSearchActive}
                                              label='Ngưng hoạt động'/><br/>
                                </div>
                            </MDBCol>
                        </MDBRow>
                    </MDBCol>
