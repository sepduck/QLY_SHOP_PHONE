...
//  List Employee ------------------------------------------------------------------------------------------------------
    ...
    const getListEmployee = () => {
        ...
        axios.get('/employee', {headers: headers})
            .then(resp => {
                setListEmployee(resp.data.data)
            })
            .catch(error => {
                console.log(error)
                navigate("/")
...
//  List gender ------------------------------------------------------------------------------------------------
    ...
    const onUserSave = () => {
        ...
        axios.post('/employee', data, {headers: headers})
            .then(() => {
                toggleOpenRegister()
            })
            .catch(error =>{
    ...
    const toggleOpenSetRoles = () => setRoleModal(!roleModal);
    ...
    const inputDataSetRoles = (e) => {
        ...
        setAddRolesInitial({...addRolesInitial, [e.target.name]: e.target.value})
    }
...
// Search Employee id -------------------------------------------------------------------------------------------------
    ...
    const onSearchEmployeeId = () => {
        let data = {
            employeeId: searchEmployeeId.employeeId,
        }
        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.get('/employee/search-id/' + data.employeeId, {headers: headers})
            .then(resp => {
                setListEmployee(resp.data.data)
            })
            .catch(error => {
...
// Search Employee Name -------------------------------------------------------------------------------------------------
    ...
    const onSearchEmployeeName = () => {
        let data = {
            employeeName: searchEmployeeName.employeeName,
        }
        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.get('/employee/search-name/' + data.employeeName, {headers: headers})
            .then(resp => {
                setListEmployee(resp.data.data)
            })
            .catch(error => {
...
// Search phone number ---------------------------------------------------------------------------------------------
    ...
    console.log(searchEmployeePhoneNumber.phoneNumber)
    const onSearchEmployeePhoneNumber = () => {
        let data = {
            phoneNumber: searchEmployeePhoneNumber.phoneNumber,
        }
        console.log(data.phoneNumber)
        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.get('/employee/search-phone-number/' + data.phoneNumber, {headers: headers})
            .then(resp => {
                console.log(data.phoneNumber)
                setListEmployee(resp.data.data)
            })
...
//  Search active ------------------------------------------------------------------------------------------------
    ...
    const onSearchActive = () => {
        ...
        axios.get('/employee/search-active/' + data.activeId, {headers: headers})
            .then(resp => {
                setListEmployee(resp.data.data)
            })
            .catch(error => {
    ...
    //  Search Add Role ------------------------------------------------------------------------------------------------
    const [addRolesInitial, setAddRolesInitial] = useState({
        userInitial: ''
    })
    console.log("addRolesInitial" + addRolesInitial.userInitial)
    const [addRoles, setAddRoles] = useState({
        userId: addRolesInitial.userInitial
    })
    console.log("addRoles" + addRoles.userId)
    ...
    const onAddRoles = () => {
        let data = {
            usersId: addRoles.userId,
        }
        const headers = {
            'Authorization': 'Bearer ' + localStorage.getItem('token')
        }
        axios.post('/employee-role/9', data,  {headers: headers})
            .then(resp => {
...
// Export ----------------------------------------------------------------------------------------------------------
    const exportToExcel = () => {
        ...
        const ws = XLSX.utils.json_to_sheet(listEmployee)
                                                ...
                                                <MDBRow>
                                                    <MDBCol md='8'>
                                                        <MDBInput className={"bg-white"}
                                                                  ...
                                                                  wrapperClass='mb-4'
                                                                  label='Theo mã nhân viên' size='lg'
                                                                  type='number'/>
                                                    </MDBCol>
                                                    <MDBCol>
                                                        <MDBBtn className='btn btn-success mb-5 text-end'
                                                                onClick={onSearchEmployeeId}>Tìm kiếm</MDBBtn>
                                                    </MDBCol>
                                                </MDBRow>
                                                <MDBRow>
                                                    <MDBCol md='8'>
                                                        <MDBInput className={"bg-white"}
                                                                  ...
                                                                  wrapperClass='mb-4'
                                                                  label='Theo tên nhân viên' size='lg'
                                                                  type='text'/>
                                                    </MDBCol>
                                                    <MDBCol>
                                                        <MDBBtn className='btn btn-success mb-5 text-end'
                                                                onClick={onSearchEmployeeName}>Tìm kiếm</MDBBtn>
                                                    </MDBCol>
                                                </MDBRow>
                                                <MDBRow>
                                                    <MDBCol md='8'>
                                                    ...
                                                    <MDBCol>
                                                        <MDBBtn className='btn btn-success mb-5 text-end'
                                                                onClick={onSearchEmployeePhoneNumber}>Tìm kiếm</MDBBtn>
                                                    </MDBCol>
                                                </MDBRow>
                                            </MDBDropdownItem>
                                        </MDBContainer>
                            ...
                            <MDBCol size='md-7'>
                                <MDBRow>
                                                                ...
                                                                <MDBRow>
                                                                    ...
                                                                    <MDBCol md="7">
                                                                        <MDBInput name={'fullName'}
                                                                                  ...
                                                                                  onChange={inputDataEmployeeSave}
                                    ...
                                    <MDBCol className='text-end'>
                                        <MDBBtn className='btn btn-success form-control'
                                                style={{textTransform: 'none'}}
                                                onClick={toggleOpenSetRoles}
                                        ><b>Set role</b></MDBBtn>
                                    </MDBCol>
                                    <MDBModal open={roleModal}
                                            ...
                                            <MDBModalContent>
                                                <MDBModalHeader>
                                                    <MDBModalTitle><b>Thêm
                                                        roles nhân viên</b></MDBModalTitle>
                                                    <MDBBtn
                                                        className='btn-close'
                                                        color='none'
                                                        onClick={toggleOpenSetRoles}></MDBBtn>
                                                </MDBModalHeader>
                                                <MDBModalBody>
                                                    <MDBRow>
                                                        <MDBCol md="4"
                                                                className="ps-3 mt-2">
                                                            <h6><b>Tên người dùng</b></h6>
                                                        </MDBCol>
                                                        <MDBCol md="7">
                                                            <select
                                                                onChange={inputDataSetRoles}
                                                                name='userId'
                                                                value={addRoles.userId}
                                                                className={'form-control'}
                                                                required
                                                            >
                            ...
                            <MDBCol>
                                <div className="w-100 p-3 shadow mb-3 bg-white rounded-4">
                                    ...
                                    <MDBRadio name='activeId'
                                              id='activeId'
                                              value={1}
                                              onChange={inputDataSearchEmployeeActive}
